    ...
    <nav class="pager">
        <?php
            if($cPage != 1) {
                $prev=$cPage-1;
        ?>
            <form action="index.php?action=changePageInfo&amp;page=<?= $prev ?>" method="post">
        ...
        <?php
            ...
            if($cPage < $totalPages) {
                $next=$cPage+1;
        ?>
            <form action="index.php?action=changePageInfo&amp;page=<?= $next ?>" method="post">
