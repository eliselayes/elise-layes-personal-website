  ...
  <html>
    ...
    <body id="editor">
      <form action="index.php?action=sendText" method="post">
        <label class="containElmForm" for="title">Titre :</label><input type="text" name="title" id="title" /><br />
        <label class="containElmForm" for="category">Catégorie :</label><input type="text" name="category" id="category" /><br />
